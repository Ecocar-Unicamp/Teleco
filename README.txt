...
The plotter is write in python using the pygame library wich makes the graphic interface and user input easy to implement.
The pyserial library is also used for the comunication with the telemetry system.
